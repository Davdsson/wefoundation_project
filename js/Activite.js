...
function getdata(){
    firebase.database().ref('Activites/').once('value').then(function(snapshot){
      //get your posts div
      ...
      for(let[key,value] of Object.entries(data)){
       ...
       "<button  class='btn1' .btn1:hover{background:red}  style=' background: #2f3191;border-radius: 3px;color: #fff;display: block;margin: 10px 10px;padding: 7px 15px;font-weight: 600;text-transform: uppercase; width:280px; border:2px solid #2f3191;margin-left:50px' id='"+key+"' onclick='delete_post(this.id)'>Sponsorisez moi</button>"+
