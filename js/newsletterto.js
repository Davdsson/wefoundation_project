...
var config = {
  ...
  document.getElementById('newletterFormto').addEventListener('submit', submitForm);
  ...
  // Save message
    ...
    // Show alert
    document.querySelector('.alerto').style.display = 'block';
  
    // Hide alert after 3 seconds
    setTimeout(function(){
      document.querySelector('.alerto').style.display = 'none';
    },3000);
  
    // Clear form
    document.getElementById('newletterFormto').reset();
  }
